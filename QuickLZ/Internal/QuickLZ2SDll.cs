namespace QuickLZ
{
    ...
    internal sealed class QuickLZ2SDll : IQuickLZDll
    {
        public QuickLZ2SDll()
        {
            ResourceExtractor.ExtractResourceToFile(2, true, "quicklz150_2s.dll");
        }

        private const string DllLocation = "quicklz150_2s.dll";
