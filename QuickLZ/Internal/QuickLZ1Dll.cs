namespace QuickLZ
{
    ...
    internal sealed class QuickLZ1Dll : IQuickLZDll
    {
        public QuickLZ1Dll()
        {
            ResourceExtractor.ExtractResourceToFile(1, false, "quicklz150_1.dll");
        }

        private const string DllLocation = "quicklz150_1.dll";
